...
> [MP Harvest v2.0.6（macOS）](https://github.com/shirainbown/mp-harvest/releases/tag/v2.0.6)
> 的 **`MP-Harvest-mac-2.0.6.dmg`**（推荐）：双击打开，把 `MP Harvest.app` 拖入「应用程序」即可
> （`MP-Harvest-mac-2.0.6.zip` 供应用内自动更新使用；当前仅 Apple Silicon；
